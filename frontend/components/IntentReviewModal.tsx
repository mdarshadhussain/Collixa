      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[var(--color-bg-secondary)] border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden"
          >
            {/* Header */}
            <div className="p-8 pb-0 flex justify-between items-start">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[var(--color-accent)] mb-2">Collaboration Feedback</p>
                <h2 className="text-2xl font-serif font-black text-white">{intentTitle}</h2>
              </div>
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                   ...
                   <p className="text-[11px] font-bold uppercase tracking-widest opacity-60">How was the collaboration with {partnerName}?</p>
                </div>
                ...
                <p className="text-center text-[10px] font-serif italic opacity-40">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                   ...
                   <p className="text-[11px] font-bold uppercase tracking-widest opacity-60">Add a testimonial (Optional)</p>
                </div>
                <textarea
                  value={comment}
                  onChange={(e) => setComment(e.target.value)}
                  placeholder="Express your gratitude or share what made this collaboration special..."
                  className="w-full h-32 bg-white/5 border border-white/10 rounded-2xl p-4 text-sm text-[var(--color-text-primary)] placeholder:opacity-20 focus:outline-none focus:border-[var(--color-accent)]/50 transition-all resize-none"
                />
              </div>
              ...
              <div className="pt-4">
                <Button
                  fullWidth
                  variant="accent"
                  className="py-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.4em]"
