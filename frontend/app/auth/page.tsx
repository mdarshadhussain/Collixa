          ...
          >
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button 
                  onClick={() => alert(`Google connection is currently being validated by Infrastructure. Please use Email Record for now.`)}
                  className="flex items-center justify-center gap-3 py-3 bg-white border border-[#EBEBEB] rounded-2xl hover:border-[#FF85BB] hover:shadow-xl hover:shadow-[#FF85BB]/5 transition-all group active:scale-95"
                >
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#021A54]">Google</span>
                </button>
                <button 
                  onClick={() => alert(`Facebook connection is currently being validated by Infrastructure. Please use Email Record for now.`)}
                  className="flex items-center justify-center gap-3 py-3 bg-white border border-[#EBEBEB] rounded-2xl hover:border-[#FF85BB] hover:shadow-xl hover:shadow-[#FF85BB]/5 transition-all group active:scale-95"
                >
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#021A54]">Facebook</span>
                </button>
              </div>
            </div>
